...
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(_contatto)));
 BA.debugLineNum = 71;BA.debugLine="If contatto.Name.ToLowerCase = frase Then";
Debug.ShouldStop(64);
if (RemoteObject.solveBoolean("=",_contatto.getField(true,"Name").runMethod(true,"toLowerCase"),main.mostCurrent._frase)) { 
