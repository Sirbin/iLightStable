...
try {
		Debug.PushSubsStack("Button1_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,91);
if (RapidSub.canDelegate("button1_click")) return main.remoteMe.runUserSub(false, "main","button1_click");
 BA.debugLineNum = 91;BA.debugLine="Sub Button1_Click";
Debug.ShouldStop(67108864);
 BA.debugLineNum = 92;BA.debugLine="voce.Listen";
...
if (RemoteObject.solveBoolean("=",main._x,BA.numberCast(double.class, 2))) { 
 BA.debugLineNum = 62;BA.debugLine="x = 0";
Debug.ShouldStop(536870912);
main._x = BA.numberCast(int.class, 0);
 BA.debugLineNum = 63;BA.debugLine="StartActivity(calls.Call(frase))";
...
{ BA.debugLineNum = 64;BA.debugLine="Else If frase = \"Internet\" Then";
Debug.ShouldStop(-2147483648);
if (RemoteObject.solveBoolean("=",main.mostCurrent._frase,BA.ObjectToString("Internet"))) { 
 BA.debugLineNum = 65;BA.debugLine="parla.Speak(\"cosa vuoi cercare?\",True)";
Debug.ShouldStop(1);
main._parla.runVoidMethod ("Speak",(Object)(BA.ObjectToString("cosa vuoi cercare?")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 66;BA.debugLine="x = 1";
Debug.ShouldStop(2);
main._x = BA.numberCast(int.class, 1);
 }else 
{ BA.debugLineNum = 67;BA.debugLine="Else If x = 3 Then";
Debug.ShouldStop(4);
if (RemoteObject.solveBoolean("=",main._x,BA.numberCast(double.class, 3))) { 
 BA.debugLineNum = 68;BA.debugLine="x = 0";
Debug.ShouldStop(8);
main._x = BA.numberCast(int.class, 0);
 BA.debugLineNum = 69;BA.debugLine="For w=0 To lista.Size-1";
Debug.ShouldStop(16);
{
final int step42 = 1;
final int limit42 = RemoteObject.solve(new RemoteObject[] {main.mostCurrent._lista.runMethod(true,"getSize"),RemoteObject.createImmutable(1)}, "-",1, 1).<Integer>get().intValue();
for (_w = 0; (step42 > 0 && _w <= limit42) || (step42 < 0 && _w >= limit42); _w = ((int)(0 + _w + step42))) {
Debug.locals.put("w", _w);
 BA.debugLineNum = 70;BA.debugLine="Dim contatto  As Contact";
Debug.ShouldStop(32);
_contatto = RemoteObject.createNew ("anywheresoftware.b4a.phone.ContactsWrapper.Contact");Debug.locals.put("contatto", _contatto);
 BA.debugLineNum = 71;BA.debugLine="contatto = lista.Get(w)";
Debug.ShouldStop(64);
_contatto = (main.mostCurrent._lista.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _w))));Debug.locals.put("contatto", _contatto);
 BA.debugLineNum = 72;BA.debugLine="Log (contatto)";
Debug.ShouldStop(128);
main.mostCurrent.__c.runVoidMethod ("Log",(Object)(BA.ObjectToString(_contatto)));
 BA.debugLineNum = 73;BA.debugLine="If contatto.Name.ToLowerCase = frase.ToLowerCase Then";
Debug.ShouldStop(256);
if (RemoteObject.solveBoolean("=",_contatto.getField(true,"Name").runMethod(true,"toLowerCase"),main.mostCurrent._frase.runMethod(true,"toLowerCase"))) { 
 BA.debugLineNum = 74;BA.debugLine="Dim telf As Int";
Debug.ShouldStop(512);
_telf = RemoteObject.createImmutable(0);Debug.locals.put("telf", _telf);
 BA.debugLineNum = 75;BA.debugLine="telf = contatto.PhoneNumber";
Debug.ShouldStop(1024);
_telf = BA.numberCast(int.class, _contatto.getField(true,"PhoneNumber"));Debug.locals.put("telf", _telf);
 BA.debugLineNum = 76;BA.debugLine="StartActivity(calls.Call(telf))";
Debug.ShouldStop(2048);
...
{ BA.debugLineNum = 79;BA.debugLine="Else If frase = \"telefono\" OR frase = \"voglio delefonare \"  Then";
...
if (RemoteObject.solveBoolean("=",main.mostCurrent._frase,BA.ObjectToString("telefono")) || RemoteObject.solveBoolean("=",main.mostCurrent._frase,BA.ObjectToString("voglio delefonare "))) { 
 BA.debugLineNum = 80;BA.debugLine="parla.Speak(\"quale numero\",True)";
Debug.ShouldStop(32768);
main._parla.runVoidMethod ("Speak",(Object)(BA.ObjectToString("quale numero")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 81;BA.debugLine="x=2";
Debug.ShouldStop(65536);
main._x = BA.numberCast(int.class, 2);
 }else 
{ BA.debugLineNum = 82;BA.debugLine="Else If frase = \"telefona contatto\" OR frase = \"telefona a contatto\" OR frase = \"contatti\" Then";
Debug.ShouldStop(131072);
if (RemoteObject.solveBoolean("=",main.mostCurrent._frase,BA.ObjectToString("telefona contatto")) || RemoteObject.solveBoolean("=",main.mostCurrent._frase,BA.ObjectToString("telefona a contatto")) || RemoteObject.solveBoolean("=",main.mostCurrent._frase,BA.ObjectToString("contatti"))) { 
 BA.debugLineNum = 83;BA.debugLine="parla.Speak(\"quale nome devo chiamare?\",True)";
...
main._parla.runVoidMethod ("Speak",(Object)(BA.ObjectToString("quale nome devo chiamare?")),(Object)(main.mostCurrent.__c.getField(true,"True")));
 BA.debugLineNum = 84;BA.debugLine="x=3";
Debug.ShouldStop(524288);
main._x = BA.numberCast(int.class, 3);
 }else {
 BA.debugLineNum = 86;BA.debugLine="parla.Speak(\"non ho capito\",True)";
Debug.ShouldStop(2097152);
...
try {
		Debug.PushSubsStack("voce_result_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,95);
if (RapidSub.canDelegate("voce_result_click")) return main.remoteMe.runUserSub(false, "main","voce_result_click");
 BA.debugLineNum = 95;BA.debugLine="Sub voce_result_Click";
Debug.ShouldStop(1073741824);
 BA.debugLineNum = 96;BA.debugLine="StartActivity(\"modulo_ilight\")";
Debug.ShouldStop(-2147483648);
